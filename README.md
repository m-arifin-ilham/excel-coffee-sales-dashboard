...
In the following project, I made an interactive Excel dashboard to analyze and visualize dummy coffee sales data, using PivotTables, dynamic charts, and functions like XLOOKUP and SUMIFS to clean and process data, derive insights, and enable real-time decision-making. The dashboard itself can be accessed in the file named "Coffee Sales Analysis Excel Dashboard.xlsx".
